...
Defines a class responsible for control of the camera. So far it's a very easy implementation that works with the mouse. But we will modify this file to include VR headset orientation and controllers.
